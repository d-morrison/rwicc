...
- [`build_phi_function_from_coefs()`](https://d-morrison.github.io/rwicc/reference/build_phi_function_from_coefs.md)
  ...
  P(Y\|T) curve:
- [`compute_mu()`](https://d-morrison.github.io/rwicc/reference/compute_mu.md)
...
- [`fit_midpoint_model()`](https://d-morrison.github.io/rwicc/reference/fit_midpoint_model.md)
